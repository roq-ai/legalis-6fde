...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Legal Researcher.create': {
    roles: ['site-owner', 'legal-analyst', 'legal-advisor'],
    key: 'document_upload',
    tenantPath: [],
    userPath: [],
  },
  'Legal Analyst.update': {
    roles: ['site-owner', 'legal-researcher', 'legal-advisor'],
    key: 'case_update',
    tenantPath: [],
    userPath: [],
  },
  'Legal Advisor.create': {
    roles: ['site-owner', 'legal-researcher', 'legal-analyst'],
    key: 'legal_advice',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['site-owner', 'legal-researcher', 'legal-analyst', 'legal-advisor', 'end-user'];
