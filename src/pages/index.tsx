  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Legalis - Empowering your legal research with comprehensive access to documents and case-related data. Discover, understand, and leverage the power of law at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsZWdhbCUyMGRvY3VtZW50c3xlbnwwfHx8fDE2OTYxMDM2OTF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Legalis - Empowering your legal research with comprehensive access to documents and case-related data. Discover, understand, and leverage the power of law at your fingertips.`}
            </Text>
            <Box
